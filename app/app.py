...
curl http://localhost:26657/broadcast_tx_commit?tx=0x01 7
...
class SimpleCounter(BaseApplication):
    ...
    def check_tx(self, tx) -> ResponseCheckTx:
        ...
        will be dropped.
        """
        print ('check tx count', self.txCount)
    ...
    def deliver_tx(self, tx) -> ResponseDeliverTx:
        ...
        print ('deliver tx count', self.txCount)
        self.txCount += 1
    ...
    def commit(self) -> ResponseCommit:
        ...
        print ('commit', self.txCount)
        hash = self.txCount.to_bytes(32, 'little')
